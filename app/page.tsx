        ...
        <div className="flex-1 text-center md:text-left">
          ...
          <h1 className="font-heading text-6xl md:text-8xl text-white leading-none mb-3 tracking-widest">
            ...
            <span
              ...
              style={{ textShadow: "0 0 30px rgba(255,87,34,0.5)" }}
            >
              DAILY
            </span>
          </h1>
          ...
          <div className="flex flex-wrap gap-3 justify-center md:justify-start">
            {["#hoopsthoughts", "#gamerecap", "#training"].map((tag, i) => (
              <div
                key={tag}
                className="px-3 py-1.5 rounded-sm bg-slate-800 border border-slate-700"
              >
                <span
                  className={`text-xs font-body font-semibold uppercase tracking-wider ${
                    i === 0 ? "text-hoop-neon" : i === 1 ? "text-hoop-orange" : "text-slate-400"
                  }`}
                >
                  {tag}
                </span>
        ...
        <div>
          ...
          {posts.length === 0 ? (
            <div className="text-center py-20">
              ...
              <p className="font-body text-slate-600">check back soon</p>
            </div>
          ) : (
